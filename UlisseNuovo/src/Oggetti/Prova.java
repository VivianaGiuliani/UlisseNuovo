...
public class Prova {
	...
	public Prova() {}
	public Prova(int quantita, String barcode, String descrizione, double peso, double caratura, double totale_riga,
			int sc_1, int sc_2, double scontato) {
		super();
	...
	public String toString() {
		return "Prova [quantita=" + quantita + ", barcode=" + barcode + ", descrizione=" + descrizione + ", peso="
				+ peso + ", caratura=" + caratura + ", totale_riga=" + totale_riga + ", sc_1=" + sc_1 + ", sc_2=" + sc_2
				+ ", scontato=" + scontato + "]";
	}
