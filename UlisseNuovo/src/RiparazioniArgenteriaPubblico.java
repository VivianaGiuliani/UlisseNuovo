...
public class RiparazioniArgenteriaPubblico extends JFrame {
    ...
    private void initUI() {
        setSize(1170, 700);
        setTitle("Riparazioni Argenteria Pubblico");
        setResizable(false);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLayout(null);

        JLabel listinoPrezziPubblicoLabel = new JLabel("Listino Prezzi al Pubblico Riparazioni Argenteria");
        listinoPrezziPubblicoLabel.setFont(new Font("Courier", Font.PLAIN, 20));
        listinoPrezziPubblicoLabel.setBounds(30, 8, 600, 30);
        add(listinoPrezziPubblicoLabel);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            RiparazioniArgenteriaPubblico ex = new RiparazioniArgenteriaPubblico();
            ex.setVisible(true);
        });
    }
}
