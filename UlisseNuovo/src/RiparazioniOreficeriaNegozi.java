...
public class RiparazioniOreficeriaNegozi extends JFrame {
    ...
    private void initUI() {
        setSize(1170, 700);
        setTitle("Riparazioni Oreficeria Negozi");
        setResizable(false);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLayout(null);

        JLabel listinoPrezziOreficeriaNegoziLabel = new JLabel("Lista Riparazioni Oreficeria Negozi");
        listinoPrezziOreficeriaNegoziLabel.setFont(new Font("Courier", Font.PLAIN, 20));
        listinoPrezziOreficeriaNegoziLabel.setBounds(30, 8, 500, 30);
        add(listinoPrezziOreficeriaNegoziLabel);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            RiparazioniOreficeriaNegozi ex = new RiparazioniOreficeriaNegozi();
            ex.setVisible(true);
        });
    }
}
